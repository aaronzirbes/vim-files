...
" Stealing from https://github.com/sjurgemeyer/dotfiles/blob/master/.vim/autoload/neomake/makers/gradleCheck.vim

function! neomake#makers#gradleCompile#gradleCompile() abort
    let g:gradleBin = filereadable('./gradlew') ? './gradlew' : 'gradle'

    return {
        \ 'exe': g:gradleBin,
        \ 'append_file': 0,
        \ 'args': ['compileGroovy', 'compileTestGroovy', '--daemon'],
