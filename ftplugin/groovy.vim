...
if has('nvim')
    ...
    "nnoremap <Leader>rn :<C-U>terminal gradle codenarcMain codenarcTest<CR>
    "nnoremap <Leader>rr :<C-U>terminal ~/.vim/gradle-test.sh '<C-R>=expand("%:t:r") <CR>'<CR>
    "nnoremap <Leader>gb :<C-U>terminal ~/.vim/gradle.sh build '<C-R>=expand("%:t:r") <CR>'<CR>
    "nnoremap <Leader>gr :<C-U>terminal ~/.vim/gradle.sh run '<C-R>=expand("%:t:r") <CR>'<CR>
